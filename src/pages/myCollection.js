...
export default function MyCollection() {
  ...
  const modalContent = [
    <div className="flex flex-col text-center rounded-xl justify-center gap-5 items-center px-20 py-5 border-8 border-white bg-blue-500">
      <h1 className="text-3xl tracking-wide text-blue-900 font-bold">
        Are you sure?
      </h1>
      <div className="flex gap-5">
        <button
          className="flex bg-red-500 px-20 py-2  font-bold rounded-full text-2xl text-white border-8 border-white"
          onClick={() => {
            setShowModal(false);
            setCollection([]);
          }}
        ...
        <button
          className="flex bg-blue-500 px-20 py-2  font-bold rounded-full text-2xl text-white border-8 border-white"
          onClick={() => {
            setShowModal(false);
          }}
        >
    ...
    <>
      {!showCard && (
        <div className="min-h-screen bg-blue-400 flex flex-col items-center ">
          {!showModal && (
            <>
              <h1 className="py-20 text-7xl font-bold font-pokemon tracking-widest text-blue-950">
                My Collection
              </h1>
